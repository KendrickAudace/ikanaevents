<div class="bc-form-search-space <?php if(!empty($style) and $style == "carousel"): ?> bc-form-search-slider <?php endif; ?>" <?php if(empty($style)): ?> style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('<?php echo e($bg_image_url); ?>') !important" <?php endif; ?>>
...
</div><?php /**PATH D:\Booking Core v4.0.1\Booking Core v4.0.1\booking-core4.0.1\bc-cms\themes/BC/Space/Views/frontend/blocks/form-search-space/index.blade.php ENDPATH**/ ?>