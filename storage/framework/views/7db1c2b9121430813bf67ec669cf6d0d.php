<div class="bc_single_book_wrap <?php if(setting_item('event_enable_inbox')): ?> has-vendor-box <?php endif; ?>">
                ...
                <div class="form-content">
                    ...
                    <div class="" v-if="ticket_types">
                        <div class="form-group form-guest-search" v-for="(type,index) in ticket_types">
                            <div class="guest-wrapper d-flex justify-content-between align-items-center"
                                v-bind:class="{ 'item-disable': type.max == 0 }">
                                <div class="flex-grow-1">
                                    <label>{{ type.name }}</label>
                                    <div class="render check-in-render">{{ type.desc }}</div>
                                    <div class="render check-in-render">{{ type.display_price }} <?php echo e(__('per ticket')); ?>
                    ...
                    <div class="form-section-group form-group" v-if="booking_time_slots">
                        ...
                        <div class="slots-wrapper d-flex justify-content-start flex-wrap">
                            <div @click="selectStartTime(time)" v-bind:class="{ 'btn-success': isInArray(time) == true }"
...
<?php /**PATH D:\Booking Core v4.0.1\Booking Core v4.0.1\booking-core4.0.1\bc-cms\themes/BC/Event/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>