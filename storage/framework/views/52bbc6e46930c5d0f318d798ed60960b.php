...
<?php if(!empty($terms_ids) and !empty($attributes)): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH D:\Booking Core v4.0.1\Booking Core v4.0.1\booking-core4.0.1\bc-cms\themes/BC/Space/Views/frontend/layouts/details/space-attributes.blade.php ENDPATH**/ ?>