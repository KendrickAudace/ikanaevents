<div class="bc_single_book_wrap <?php if(setting_item('tour_enable_inbox')): ?> has-vendor-box <?php endif; ?>">
            ...
            <div class="form-book" v-bind:class="{ 'd-none': enquiry_type != 'book' }">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="input-number-group">
                                        <select v-if="allEvents" v-model="start_date" class="custom-select">
                                            <option v-for="(data,index) in allEvents" v-bind:value="data.start">
                                                {{ data.start }}</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group form-guest-search" v-for="(type,index) in person_types">
                            <div class="guest-wrapper d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="render check-in-render">{{ type.display_price }} <?php echo e(__('per person')); ?>
                ...
                <div class="submit-group">
                    <a class="btn btn-large" @click="doSubmit($event)"
                        v-bind:class="{ 'disabled': onSubmit, 'btn-success': (step == 2), 'btn-primary': step == 1 }"
                        name="submit">
...
<?php /**PATH D:\Booking Core v4.0.1\Booking Core v4.0.1\booking-core4.0.1\bc-cms\themes/BC/Tour/Views/frontend/layouts/details/tour-form-book.blade.php ENDPATH**/ ?>