<div class="bc_single_book_wrap">
    <div class="bc_single_book">
        <div id="bc_boat_book_app" v-cloak>
            <div class="form-head">
                        ...
                        <div class="date-wrapper clearfix align-items-start" @click="openStartDate">
                            <div class="check-in-wrapper">
                                ...
                                <small class="alert-text mt10 mt-2" v-show="message2.content" v-html="message2.content"
                                    v-bind:class="{ 'danger': !message2.type, 'success': message2.type }"></small>
                            </div>
...
<?php /**PATH D:\Booking Core v4.0.1\Booking Core v4.0.1\booking-core4.0.1\bc-cms\themes/BC/Boat/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>